...
export async function GET(req: Request) {
  ...
  const billingKeywords = ['billing', 'invoice', 'tax', 'payment', 'charge', 'refund', 'subscription', 'price', 'cost', 'bill'];
  const performanceKeywords = ['slow', 'lag', 'performance', 'speed', 'load', 'timeout', 'crash', 'freeze', 'bug', 'error'];
  const supportKeywords = ['support', 'ticket', 'reply', 'response', 'wait', 'delay', 'help', 'assist', 'ignore', 'unresponsive'];
